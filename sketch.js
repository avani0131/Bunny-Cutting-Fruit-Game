...
function preload()
{
  ...
  empty1 = loadAnimation('one_star.png');
  empty2 = loadAnimation('stars.png');
...
function setup() 
{
  ...
  star1 = createSprite (300,35,30,30)
  star1.addImage(star_IMG)
  star1.scale = 0.03;

  star2 = createSprite (70,360,30,30)
  star2.addImage(star_IMG)
  star2.scale = 0.03;

  stars = createSprite (80,35,30,30);
  stars.scale=0.3;
  stars.addAnimation('empty',empty);
  stars.addAnimation('1',empty1);
  stars.addAnimation('two',empty2);
